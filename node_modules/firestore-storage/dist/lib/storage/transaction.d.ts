...
export declare class FirestoreTransaction {
    ...
    update<T extends BaseModel, Path extends CollectionPath<any, any, any>>(repo: BaseRepository<T, Path>, data: PatchUpdate<ModelDataWithId<T>>, ids: CollectionIds<Path>): FirestoreTransaction;
